                ...
                <div class="col-md-4">
                    <form id="data-prove">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="correo" class="form-control" placeholder="correo@gmail.com" required="ON">
                        </div>
                        ...
                        if ($num_registro > $registros) : ?>
                            <?php if ($pagina == 1) : ?>
                                <div style="text-align: center;">
                                    <a href="" class="btn btn-info pagina" v-num="<?php echo ($pagina - 0); ?>" num-reg="<?php echo $registros; ?>">
                                    <i class="far fa-arrow-alt-circle-left fa-2x"></i>
                                    </a>
                                    <a href="" class="btn btn-info pagina" v-num="<?php echo ($pagina + 1); ?>" num-reg="<?php echo $registros; ?>">
