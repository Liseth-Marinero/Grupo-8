...
$tabla = "productos";
$campos = "nombre_producto,descripcion, precio_compra, cantidad, precio_venta,categoria, imagen_cate";
$valores = "'$nombre_producto','$descripcion','$precio_compra','$cantidad','$precio_venta','$categoria','$newName'";
